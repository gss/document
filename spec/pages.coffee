...
describe 'Standalone page tests', -> 
  ...
  describe 'Grid website', ->
    ...
    ['with worker', 'without worker'].forEach (type) ->
      describe type, ->
        describe 'Virtuals demo', ->
          ...
          it 'should reorient', (done) ->
            ...
            iframe.width = 1024
            iframe.height = 768
            iframe.src = './pages/virtuals.html?log=0.5&type=' + type
        ...
        describe 'Simple post', ->
          ...
          it 'should reorient', (done) ->
            ...
            iframe.width = 1024
            iframe.height = 768
            iframe.src = './pages/grid_post_simple.html?log=0.5&type=' + type
        ...
        describe 'Reposts', ->
          ...
          it 'should reorient', (done) ->
            ...
            iframe.width = 1024
            iframe.height = 768
            iframe.src = './pages/grid_reposts.html?log=0.5&type=' + type 
        ...
        xdescribe 'Head cta section', ->
          ...
          it 'should reorient', (done) ->
            ...
            iframe.width = 1024
            iframe.height = 768
            iframe.src = './pages/grid_head_cta.html?log=0.5&type=' + type
        ...
        describe 'Team section', ->
          ...
          it 'should reorient', (done) ->
            ...
            iframe.width = 1024
            iframe.height = 768
            iframe.src = './pages/grid_team.html?log=0.5&type=' + type
